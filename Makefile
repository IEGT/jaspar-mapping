...
check: pssm_scan $(TEST_BINARIES)
	...
	bash tests/test_motif_context_slurm_worker.sh
...
check-duckdb: cutandrun_score_calibration pssm_scan_parquet
	...
	bash tests/test_h3k4me3_genome_signal_manager.sh
	bash tests/test_h3k4me3_cofactor_analysis_manager.sh
	bash tests/test_h3k4me3_genome_cofactor_summary.sh
	bash tests/test_jaspar_metadata_catalog.sh
