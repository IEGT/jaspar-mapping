...
create.lists.for.chromosome <- function(m, reportdir="Reports",offset=0.01) {
    ...
    cat("I: deriving data for chromosome ",chromosome,".\n",sep="")
    ...
    cat("I: ... Association of CUT&RUN data with PSSM binding sites\n")
    ## The number of PSSM matches that are in the top 1%,10%,25%,50% of CUT&RUN data
    sum.NumInWindow.tp73.equal.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73 <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.tp73.filtered.90") <- sum.NumInWindow.tp73.filtered.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73 >= sum.cutandrun.tp73.quantile.90 ]))
    ...
    sum.NumInWindow.pos.equal.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.pos <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.pos.filtered.90") <- sum.NumInWindow.pos.filtered.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.pos >= sum.cutandrun.pos.quantile.90 ]))
    ...
    ratio.tp73.50 <- (sum.NumInWindow.tp73.filtered.50/sum(sum.cutandrun.tp73>=sum.cutandrun.tp73.quantile.50)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.tp73 <= 0+offset))
    ratio.tp73.75 <- (sum.NumInWindow.tp73.filtered.75/sum(sum.cutandrun.tp73>=sum.cutandrun.tp73.quantile.75)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.tp73 <= 0+offset))
    attr(m,"ratio.tp73.90") <- ratio.tp73.90 <- (sum.NumInWindow.tp73.filtered.90/sum(sum.cutandrun.tp73>=sum.cutandrun.tp73.quantile.90)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.tp73 <= 0+offset))
    ratio.tp73.95 <- (sum.NumInWindow.tp73.filtered.95/sum(sum.cutandrun.tp73>=sum.cutandrun.tp73.quantile.95)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.tp73 <= 0+offset))
    ...
    ratio.tp73.99 <- (
                    ...
                    /
                    sum(sum.cutandrun.tp73 <= 0+offset)      # Number of in TFBS that have no coverage in TP73 cut'n'run
                )

    ratio.pos.50 <- (sum.NumInWindow.pos.filtered.50/sum(sum.cutandrun.pos >= sum.cutandrun.pos.quantile.50)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.pos <= 0+offset))
    ratio.pos.75 <- (sum.NumInWindow.pos.filtered.75/sum(sum.cutandrun.pos >= sum.cutandrun.pos.quantile.75)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.pos <= 0+offset))
    attr(m,"ratio.pos.90") <- ratio.pos.90 <- (sum.NumInWindow.pos.filtered.90/sum(sum.cutandrun.pos >= sum.cutandrun.pos.quantile.90)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.pos <= 0+offset))
    ratio.pos.95 <- (sum.NumInWindow.pos.filtered.95/sum(sum.cutandrun.pos >= sum.cutandrun.pos.quantile.95)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.pos <= 0+offset))
    ratio.pos.99 <- (sum.NumInWindow.pos.filtered.99/sum(sum.cutandrun.pos >= sum.cutandrun.pos.quantile.99)) / (sum.NumInWindow.tp73.equal.0/sum(sum.cutandrun.pos <= 0+offset))
    ...
    sum.NumInWindow.equal.TAa.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.TAa <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.TAa.quantile.90") <- sum.NumInWindow.filtered.TAa.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.TAa >= sum.cutandrun.tp73.TAa.quantile.90]))
    ...
    ratio.TAa.quantile.50 <- (sum.NumInWindow.filtered.TAa.quantile.50/sum(sum.cutandrun.tp73.TAa>=sum.cutandrun.tp73.TAa.quantile.50)) / (sum.NumInWindow.equal.TAa.0/sum(sum.cutandrun.tp73.TAa <= 0+offset))
    ratio.TAa.quantile.75 <- (sum.NumInWindow.filtered.TAa.quantile.75/sum(sum.cutandrun.tp73.TAa>=sum.cutandrun.tp73.TAa.quantile.75)) / (sum.NumInWindow.equal.TAa.0/sum(sum.cutandrun.tp73.TAa <= 0+offset))
    ratio.TAa.quantile.90 <- (sum.NumInWindow.filtered.TAa.quantile.90/sum(sum.cutandrun.tp73.TAa>=sum.cutandrun.tp73.TAa.quantile.90)) / (sum.NumInWindow.equal.TAa.0/sum(sum.cutandrun.tp73.TAa <= 0+offset))
    ratio.TAa.quantile.95 <- (sum.NumInWindow.filtered.TAa.quantile.95/sum(sum.cutandrun.tp73.TAa>=sum.cutandrun.tp73.TAa.quantile.95)) / (sum.NumInWindow.equal.TAa.0/sum(sum.cutandrun.tp73.TAa <= 0+offset))
    ratio.TAa.quantile.99 <- (sum.NumInWindow.filtered.TAa.quantile.99/sum(sum.cutandrun.tp73.TAa>=sum.cutandrun.tp73.TAa.quantile.99)) / (sum.NumInWindow.equal.TAa.0/sum(sum.cutandrun.tp73.TAa <= 0+offset))
    sum.NumInWindow.equal.DNb.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.DNb <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.DNb.quantile.90") <- sum.NumInWindow.filtered.DNb.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.DNb >= sum.cutandrun.tp73.DNb.quantile.90]))
    ...
    ratio.DNb.quantile.50 <- (sum.NumInWindow.filtered.DNb.quantile.50/sum(sum.cutandrun.tp73.DNb>=sum.cutandrun.tp73.DNb.quantile.50)) / (sum.NumInWindow.equal.DNb.0/sum(sum.cutandrun.tp73.DNb <= 0+offset))
    ratio.DNb.quantile.75 <- (sum.NumInWindow.filtered.DNb.quantile.75/sum(sum.cutandrun.tp73.DNb>=sum.cutandrun.tp73.DNb.quantile.75)) / (sum.NumInWindow.equal.DNb.0/sum(sum.cutandrun.tp73.DNb <= 0+offset))
    attr(m,"ratio.DNb.quantile.90") <- ratio.DNb.quantile.90 <- (sum.NumInWindow.filtered.DNb.quantile.99/sum(sum.cutandrun.tp73.DNb>=sum.cutandrun.tp73.DNb.quantile.90)) / (sum.NumInWindow.equal.DNb.0/sum(sum.cutandrun.tp73.DNb <= 0+offset))
    ratio.DNb.quantile.95 <- (sum.NumInWindow.filtered.DNb.quantile.95/sum(sum.cutandrun.tp73.DNb>=sum.cutandrun.tp73.DNb.quantile.95)) / (sum.NumInWindow.equal.DNb.0/sum(sum.cutandrun.tp73.DNb <= 0+offset))
    ratio.DNb.quantile.99 <- (sum.NumInWindow.filtered.DNb.quantile.99/sum(sum.cutandrun.tp73.DNb>=sum.cutandrun.tp73.DNb.quantile.99)) / (sum.NumInWindow.equal.DNb.0/sum(sum.cutandrun.tp73.DNb <= 0+offset))
    sum.NumInWindow.equal.GFP.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.GFP <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.GFP.quantile.90") <- sum.NumInWindow.filtered.GFP.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[sum.cutandrun.tp73.GFP >= sum.cutandrun.tp73.GFP.quantile.90]))
    ...
    ratio.GFP.quantile.50 <- (sum.NumInWindow.filtered.GFP.quantile.50/sum(sum.cutandrun.tp73.GFP>=sum.cutandrun.tp73.GFP.quantile.50)) / (sum.NumInWindow.equal.GFP.0/sum(sum.cutandrun.tp73.GFP <= 0+offset))
    ratio.GFP.quantile.75 <- (sum.NumInWindow.filtered.GFP.quantile.75/sum(sum.cutandrun.tp73.GFP>=sum.cutandrun.tp73.GFP.quantile.75)) / (sum.NumInWindow.equal.GFP.0/sum(sum.cutandrun.tp73.GFP <= 0+offset))
    attr(m,"ratio.GFP.quantile.90") <- ratio.GFP.quantile.90 <- (sum.NumInWindow.filtered.GFP.quantile.90/sum(sum.cutandrun.tp73.GFP>=sum.cutandrun.tp73.GFP.quantile.90)) / (sum.NumInWindow.equal.GFP.0/sum(sum.cutandrun.tp73.GFP <= 0+offset))
    ratio.GFP.quantile.95 <- (sum.NumInWindow.filtered.GFP.quantile.95/sum(sum.cutandrun.tp73.GFP>=sum.cutandrun.tp73.GFP.quantile.95)) / (sum.NumInWindow.equal.GFP.0/sum(sum.cutandrun.tp73.GFP <= 0+offset))
    ratio.GFP.quantile.99 <- (sum.NumInWindow.filtered.GFP.quantile.99/sum(sum.cutandrun.tp73.GFP>=sum.cutandrun.tp73.GFP.quantile.99)) / (sum.NumInWindow.equal.GFP.0/sum(sum.cutandrun.tp73.GFP <= 0+offset))
    ...
    attr(m,"ratio.TAa.quantile.90.vs.ratio.DNb.quantile.90") <- ratio.TAa.quantile.90.vs.ratio.DNb.quantile.90 <- ratio.TAa.quantile.90 / ratio.DNb.quantile.90
    ...
    sum.NumInWindow.equal.saos2.TAa.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_saos2_TA" <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.saos2.TAa.quantile.90") <- sum.NumInWindow.filtered.saos2.TAa.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_saos2_TA" >= sum.cutandrun.tp73.saos2.TAa.quantile.90]))
    ...
    ratio.saos2.TAa.quantile.50 <- (sum.NumInWindow.filtered.saos2.TAa.quantile.50/sum(m$"tp73_saos2_TA">=sum.cutandrun.tp73.saos2.TAa.quantile.50)) / (sum.NumInWindow.equal.saos2.TAa.0/sum(m$"tp73_saos2_TA" <= 0+offset))
    ratio.saos2.TAa.quantile.75 <- (sum.NumInWindow.filtered.saos2.TAa.quantile.75/sum(m$"tp73_saos2_TA">=sum.cutandrun.tp73.saos2.TAa.quantile.75)) / (sum.NumInWindow.equal.saos2.TAa.0/sum(m$"tp73_saos2_TA" <= 0+offset))
    attr(m,"ratio.saos2.TAa.quantile.90") <- ratio.saos2.TAa.quantile.90 <- (sum.NumInWindow.filtered.saos2.TAa.quantile.90/sum(m$"tp73_saos2_TA">=sum.cutandrun.tp73.saos2.TAa.quantile.90)) / (sum.NumInWindow.equal.saos2.TAa.0/sum(m$"tp73_saos2_TA" <= 0+offset))
    ratio.saos2.TAa.quantile.95 <- (sum.NumInWindow.filtered.saos2.TAa.quantile.95/sum(m$"tp73_saos2_TA">=sum.cutandrun.tp73.saos2.TAa.quantile.95)) / (sum.NumInWindow.equal.saos2.TAa.0/sum(m$"tp73_saos2_TA" <= 0+offset))
    ratio.saos2.TAa.quantile.99 <- (sum.NumInWindow.filtered.saos2.TAa.quantile.99/sum(m$"tp73_saos2_TA">=sum.cutandrun.tp73.saos2.TAa.quantile.99)) / (sum.NumInWindow.equal.saos2.TAa.0/sum(m$"tp73_saos2_TA" <= 0+offset))

    sum.NumInWindow.equal.saos2.DNb.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_saos2_DN" <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.saos2.DNb.quantile.90") <- sum.NumInWindow.filtered.saos2.DNb.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_saos2_DN" >= sum.cutandrun.tp73.saos2.DNb.quantile.90]))
    ...
    ratio.saos2.DNb.quantile.50 <- (sum.NumInWindow.filtered.saos2.DNb.quantile.50/sum(m$"tp73_saos2_DN">=sum.cutandrun.tp73.saos2.DNb.quantile.50)) / (sum.NumInWindow.equal.saos2.DNb.0/sum(m$"tp73_saos2_DN"<=0+offset))
    ratio.saos2.DNb.quantile.75 <- (sum.NumInWindow.filtered.saos2.DNb.quantile.75/sum(m$"tp73_saos2_DN">=sum.cutandrun.tp73.saos2.DNb.quantile.75)) / (sum.NumInWindow.equal.saos2.DNb.0/sum(m$"tp73_saos2_DN"<=0+offset))
    attr(m,"ratio.saos2.DNb.quantile.90") <- ratio.saos2.DNb.quantile.90 <- (sum.NumInWindow.filtered.saos2.DNb.quantile.90/sum(m$"tp73_saos2_DN">=sum.cutandrun.tp73.saos2.DNb.quantile.90)) / (sum.NumInWindow.equal.saos2.DNb.0/sum(m$"tp73_saos2_DN" <= 0+offset))
    ratio.saos2.DNb.quantile.95 <- (sum.NumInWindow.filtered.saos2.DNb.quantile.95/sum(m$"tp73_saos2_DN">=sum.cutandrun.tp73.saos2.DNb.quantile.95)) / (sum.NumInWindow.equal.saos2.DNb.0/sum(m$"tp73_saos2_DN"<=0+offset))
    ratio.saos2.DNb.quantile.99 <- (sum.NumInWindow.filtered.saos2.DNb.quantile.99/sum(m$"tp73_saos2_DN">=sum.cutandrun.tp73.saos2.DNb.quantile.99)) / (sum.NumInWindow.equal.saos2.DNb.0/sum(m$"tp73_saos2_DN"<=0+offset))

    sum.NumInWindow.equal.saos2.GFP.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_saos2_GFP" <= 0+offset]))
    ...
    ratio.saos2.GFP.quantile.50 <- (sum.NumInWindow.filtered.saos2.GFP.quantile.50/sum(m$"tp73_saos2_GFP">=sum.cutandrun.tp73.saos2.GFP.quantile.50)) / (sum.NumInWindow.equal.saos2.GFP.0/sum(m$"tp73_saos2_GFP"<=0+offset))
    ratio.saos2.GFP.quantile.75 <- (sum.NumInWindow.filtered.saos2.GFP.quantile.75/sum(m$"tp73_saos2_GFP">=sum.cutandrun.tp73.saos2.GFP.quantile.75)) / (sum.NumInWindow.equal.saos2.GFP.0/sum(m$"tp73_saos2_GFP"<=0+offset))
    attr(m,"ratio.saos2.GFP.quantile.90") <- ratio.saos2.GFP.quantile.90 <- (sum.NumInWindow.filtered.saos2.GFP.quantile.90/sum(m$"tp73_saos2_GFP">=sum.cutandrun.tp73.saos2.GFP.quantile.90)) / (sum.NumInWindow.equal.saos2.GFP.0/sum(m$"tp73_saos2_GFP"<=0+offset))
    ratio.saos2.GFP.quantile.95 <- (sum.NumInWindow.filtered.saos2.GFP.quantile.95/sum(m$"tp73_saos2_GFP">=sum.cutandrun.tp73.saos2.GFP.quantile.95)) / (sum.NumInWindow.equal.saos2.GFP.0/sum(m$"tp73_saos2_GFP"<=0+offset))
    ratio.saos2.GFP.quantile.99 <- (sum.NumInWindow.filtered.saos2.GFP.quantile.99/sum(m$"tp73_saos2_GFP">=sum.cutandrun.tp73.saos2.GFP.quantile.99)) / (sum.NumInWindow.equal.saos2.GFP.0/sum(m$"tp73_saos2_GFP"<=0+offset))
    ...
    sum.NumInWindow.equal.skmel29_2.TAa.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_TA" <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.skmel29_2.TAa.quantile.90") <- sum.NumInWindow.filtered.skmel29_2.TAa.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_TA" >= sum.cutandrun.tp73.skmel29_2.TAa.quantile.90]))
    ...
    sum.NumInWindow.filtered.skmel29_2.TAa.quantile.99 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_TA" >= sum.cutandrun.tp73.skmel29_2.TAa.quantile.99]))
                    # Number of TFBS for particular TF in top 1% of CUT&RUN confirmed sites
                                                        # Number of TFBS in top 1% of confirmed sites
    ratio.skmel29_2.TAa.quantile.50 <- (sum.NumInWindow.filtered.skmel29_2.TAa.quantile.50/sum(m$"tp73_skmel29_2_TA">=sum.cutandrun.tp73.skmel29_2.TAa.quantile.50)) / (sum.NumInWindow.equal.skmel29_2.TAa.0/sum(m$"tp73_skmel29_2_TA" <= 0+offset))
    ratio.skmel29_2.TAa.quantile.75 <- (sum.NumInWindow.filtered.skmel29_2.TAa.quantile.75/sum(m$"tp73_skmel29_2_TA">=sum.cutandrun.tp73.skmel29_2.TAa.quantile.75)) / (sum.NumInWindow.equal.skmel29_2.TAa.0/sum(m$"tp73_skmel29_2_TA" <= 0+offset))
    attr(m,"ratio.skmel29_2.TAa.quantile.90") <- ratio.skmel29_2.TAa.quantile.90 <- (sum.NumInWindow.filtered.skmel29_2.TAa.quantile.90/sum(m$"tp73_skmel29_2_TA">=sum.cutandrun.tp73.skmel29_2.TAa.quantile.90)) / (sum.NumInWindow.equal.skmel29_2.TAa.0/sum(m$"tp73_skmel29_2_TA" <= 0+offset))
    ratio.skmel29_2.TAa.quantile.95 <- (sum.NumInWindow.filtered.skmel29_2.TAa.quantile.95/sum(m$"tp73_skmel29_2_TA">=sum.cutandrun.tp73.skmel29_2.TAa.quantile.95)) / (sum.NumInWindow.equal.skmel29_2.TAa.0/sum(m$"tp73_skmel29_2_TA" <= 0+offset))
    ratio.skmel29_2.TAa.quantile.99 <- (sum.NumInWindow.filtered.skmel29_2.TAa.quantile.99/sum(m$"tp73_skmel29_2_TA">=sum.cutandrun.tp73.skmel29_2.TAa.quantile.99)) / (sum.NumInWindow.equal.skmel29_2.TAa.0/sum(m$"tp73_skmel29_2_TA" <= 0+offset))

    sum.NumInWindow.equal.skmel29_2.DNb.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_DN" <= 0+offset]))
    ...
    ratio.skmel29_2.DNb.quantile.50 <- (sum.NumInWindow.filtered.skmel29_2.DNb.quantile.50/sum(m$"tp73_skmel29_2_DN">=sum.cutandrun.tp73.skmel29_2.DNb.quantile.50)) / (sum.NumInWindow.equal.skmel29_2.DNb.0/sum(m$"tp73_skmel29_2_DN" <= 0+offset))
    ratio.skmel29_2.DNb.quantile.75 <- (sum.NumInWindow.filtered.skmel29_2.DNb.quantile.75/sum(m$"tp73_skmel29_2_DN">=sum.cutandrun.tp73.skmel29_2.DNb.quantile.75)) / (sum.NumInWindow.equal.skmel29_2.DNb.0/sum(m$"tp73_skmel29_2_DN" <= 0+offset))
    attr(m,"ratio.skmel29_2.DNb.quantile.90") <- ratio.skmel29_2.DNb.quantile.90 <- (sum.NumInWindow.filtered.skmel29_2.DNb.quantile.90/sum(m$"tp73_skmel29_2_DN">=sum.cutandrun.tp73.skmel29_2.DNb.quantile.90)) / (sum.NumInWindow.equal.skmel29_2.DNb.0/sum(m$"tp73_skmel29_2_DN" <= 0+offset))
    ratio.skmel29_2.DNb.quantile.95 <- (sum.NumInWindow.filtered.skmel29_2.DNb.quantile.95/sum(m$"tp73_skmel29_2_DN">=sum.cutandrun.tp73.skmel29_2.DNb.quantile.95)) / (sum.NumInWindow.equal.skmel29_2.DNb.0/sum(m$"tp73_skmel29_2_DN" <= 0+offset))
    ratio.skmel29_2.DNb.quantile.99 <- (sum.NumInWindow.filtered.skmel29_2.DNb.quantile.99/sum(m$"tp73_skmel29_2_DN">=sum.cutandrun.tp73.skmel29_2.DNb.quantile.99)) / (sum.NumInWindow.equal.skmel29_2.DNb.0/sum(m$"tp73_skmel29_2_DN" <= 0+offset))

    sum.NumInWindow.equal.skmel29_2.GFP.0 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_GFP" <= 0+offset]))
    ...
    attr(m,"sum.NumInWindow.filtered.skmel29_2.GFP.quantile.90") <- sum.NumInWindow.filtered.skmel29_2.GFP.quantile.90 <- sapply(m[, ..cols.NumInWindow], function(X) sum(X[m$"tp73_skmel29_2_GFP" >= sum.cutandrun.tp73.skmel29_2.GFP.quantile.90]))
    ...
    ratio.skmel29_2.GFP.quantile.50 <- (sum.NumInWindow.filtered.skmel29_2.GFP.quantile.50/sum(m$"tp73_skmel29_2_GFP">=sum.cutandrun.tp73.skmel29_2.GFP.quantile.50)) / (sum.NumInWindow.equal.skmel29_2.GFP.0/sum(m$"tp73_skmel29_2_GFP" <= 0+offset))
    ratio.skmel29_2.GFP.quantile.75 <- (sum.NumInWindow.filtered.skmel29_2.GFP.quantile.75/sum(m$"tp73_skmel29_2_GFP">=sum.cutandrun.tp73.skmel29_2.GFP.quantile.75)) / (sum.NumInWindow.equal.skmel29_2.GFP.0/sum(m$"tp73_skmel29_2_GFP" <= 0+offset))
    attr(m,"ratio.skmel29_2.GFP.quantile.90") <- ratio.skmel29_2.GFP.quantile.90 <- (sum.NumInWindow.filtered.skmel29_2.GFP.quantile.90/sum(m$"tp73_skmel29_2_GFP">=sum.cutandrun.tp73.skmel29_2.GFP.quantile.90)) / (sum.NumInWindow.equal.skmel29_2.GFP.0/sum(m$"tp73_skmel29_2_GFP" <= 0+offset))
    ratio.skmel29_2.GFP.quantile.95 <- (sum.NumInWindow.filtered.skmel29_2.GFP.quantile.95/sum(m$"tp73_skmel29_2_GFP">=sum.cutandrun.tp73.skmel29_2.GFP.quantile.95)) / (sum.NumInWindow.equal.skmel29_2.GFP.0/sum(m$"tp73_skmel29_2_GFP" <= 0+offset))
    ratio.skmel29_2.GFP.quantile.99 <- (sum.NumInWindow.filtered.skmel29_2.GFP.quantile.99/sum(m$"tp73_skmel29_2_GFP">=sum.cutandrun.tp73.skmel29_2.GFP.quantile.99)) / (sum.NumInWindow.equal.skmel29_2.GFP.0/sum(m$"tp73_skmel29_2_GFP" <= 0+offset))
    ...
    attr(m,"ratio.skmel29_2.TAa.quantile.90.vs.ratio.skmel29_2.DNb.quantile.90") <- ratio.skmel29_2.TAa.quantile.90.vs.ratio.skmel29_2.DNb.quantile.90 <- ratio.skmel29_2.TAa.quantile.90 / ratio.skmel29_2.DNb.quantile.90
    ...
    attr(m,"ratio.skmel29_2.TAa.quantile.90.vs.ratio.skmel29_2.GFP.quantile.90") <- ratio.skmel29_2.TAa.quantile.90.vs.ratio.skmel29_2.GFP.quantile.90 <- ratio.skmel29_2.TAa.quantile.90 / ratio.skmel29_2.GFP.quantile.90
    ...
    attr(m,"ratio.skmel29_2.DNb.quantile.90.vs.ratio.skmel29_2.GFP.quantile.90") <- ratio.skmel29_2.DNb.quantile.90.vs.ratio.skmel29_2.GFP.quantile.90 <- ratio.skmel29_2.DNb.quantile.90 / ratio.skmel29_2.GFP.quantile.90
    ...
    attr(m,"ratio.skmel29_2.TAa.quantile.90.vs.ratio.saos2.TAa.quantile.90") <- ratio.skmel29_2.TAa.quantile.90.vs.ratio.saos2.TAa.quantile.90 <- ratio.skmel29_2.TAa.quantile.90 / ratio.saos2.TAa.quantile.90
    ...
    attr(m,"ratio.skmel29_2.DNb.quantile.90.vs.ratio.saos2.DNb.quantile.90") <- ratio.skmel29_2.DNb.quantile.90.vs.ratio.saos2.DNb.quantile.90 <- ratio.skmel29_2.DNb.quantile.90 / ratio.saos2.DNb.quantile.90
    ...
    attr(m,"ratio.skmel29_2.GFP.quantile.90.vs.ratio.saos2.GFP.quantile.90") <- ratio.skmel29_2.GFP.quantile.90.vs.ratio.saos2.GFP.quantile.90 <- ratio.skmel29_2.GFP.quantile.90 / ratio.saos2.GFP.quantile.90
    ...
    attr(m,"mean.NumInWindow.filtered.saos2.TAa.quantile.90.wo.DNb.quantile.50") <- mean.NumInWindow.filtered.saos2.TAa.quantile.90.wo.DNb.quantile.50 <- 
    ...
    attr(m,"mean.NumInWindow.filtered.saos2.DNb.quantile.90.wo.TAa.quantile.50") <- mean.NumInWindow.filtered.saos2.DNb.quantile.90.wo.TAa.quantile.50 <- 
        sapply(m[, ..cols.NumInWindow], function(X) mean(X[
            m$"tp73_saos2_TA" >= sum.cutandrun.tp73.saos2.DNb.quantile.90 & m$"tp73_saos2_DN" <= sum.cutandrun.tp73.saos2.TAa.quantile.50
            ]))

    attr(m,"ratio.saos2.TAa.quantile.90.wo.DNb.quantile.50.vs.saos2.DNb.quantile.90.wo.TAa.quantile.50") <- ratio.saos2.TAa.quantile.90.wo.DNb.quantile.50.vs.saos2.DNb.quantile.90.wo.TAa.quantile.50 <-
    ...
    attr(m,"mean.NumInWindow.filtered.skmel29_2.TAa.quantile.90.wo.DNb.quantile.50") <- mean.NumInWindow.filtered.skmel29_2.TAa.quantile.90.wo.DNb.quantile.50 <- 
        sapply(m[, ..cols.NumInWindow], function(X) mean(X[
    ...
    attr(m,"mean.NumInWindow.filtered.skmel29_2.DNb.quantile.90.wo.TAa.quantile.50") <- mean.NumInWindow.filtered.skmel29_2.DNb.quantile.90.wo.TAa.quantile.50 <- 
        sapply(m[, ..cols.NumInWindow], function(X) mean(X[
    ...
    attr(m,"ratio.skmel29_2.TAa.quantile.90.wo.DNb.quantile.50.vs.skmel29_2.DNb.quantile.90.wo.TAa.quantile.50") <- ratio.skmel29_2.TAa.quantile.90.wo.DNb.quantile.50.vs.skmel29_2.DNb.quantile.90.wo.TAa.quantile.50 <- 
    ...
    attr(m,"ratio.ratio.skmel29_2.vs.saos2.of.TAa.wo.DNb.vs.DNb.wo.TAa") <- ratio.ratio.skmel29_2.vs.saos2.of.TAa.wo.DNb.vs.DNb.wo.TAa <- 
