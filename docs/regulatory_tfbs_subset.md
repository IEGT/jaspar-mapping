...
Implementation is locally tested. No genome-wide export has been submitted
by this change, and the full regulatory subset's disk size remains unmeasured.
The first production step should be bounded exports and counting on Haumea,
then a deliberately sized collaborator panel, not a laptop download of the
whole permissive atlas.
